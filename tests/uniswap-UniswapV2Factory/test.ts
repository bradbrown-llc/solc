...
console.log(foo)
console.log(foo.contracts!['UniswapV2Factory.sol']!['UniswapV2Pair']!.evm.bytecode!.object)
console.log(foo.contracts!['UniswapV2Factory.sol']!['UniswapV2Factory']!.evm.bytecode!.object)
